//** Testes com mocks */
//** Luiz Carlos disse que os testes de agregados devem ser feitos juntos */
//** Portanto não seria necessário usar mocks */
//** Fiz esses testes somente para aprender caso seja necessário */
...
jest.mock("./../supplier/domain/entities/supplier", () => {
  // Works and lets you check for constructor calls:
  return {
    Supplier: jest.fn().mockImplementation(() => {
      return { name: "good supplier" };
    }),
  };
});

jest.mock("./../team/domain/entities/team", () => {
  // Works and lets you check for constructor calls:
  return {
