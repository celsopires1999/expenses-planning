...
describe("Team Unit Test", () => {
  ...
  test("constructor of category with all props", () => {
    ...
    let entity = new Team(props, auditFieldsProps);
  ...
  test("constructor with mandatory props only", () => {
    const entity = new Team(testProps, { created_by: "user" });
  ...
  test("getter of created_by prop", () => {
    const entity = new Team(testProps, { created_by: "system" });
  ...
  test("getter of updated_by prop", () => {
    const entity = new Team(testProps, {
      created_by: "user",
      updated_by: "system",
    });
  ...
  describe("id prop", () => {
    ...
    test.each(arrange)("%#) when props are %j", (item) => {
      const entity = new Team(testProps, { created_by: "user" }, item.id);
